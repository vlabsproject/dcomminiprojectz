      ...
      if (h.creditHref) {
        h._creditLink ||
          ...
          h._creditLink.setAttribute(
            "style",
            "outline:none;margin:0px;position:relative;right:12px;top:" +
              (h.height - 14) +
              "px;color:white;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"
          ),
  ...
  (function () {
    ...
    function O(a) {
      ...
      a.styleSheets.ex_canvas_ ||
        ...
        (a.cssText =
          "canvas{display:inline-block;overflow:hidden;text-align:right;width:300px;height:150px}"));
    }
    function X(a) {
      var b = a.srcElement;
